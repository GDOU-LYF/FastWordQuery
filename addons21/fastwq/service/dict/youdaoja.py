...
@register([u'有道词典-日语', u'Youdao-Japan'])
class YoudaoJa(WebService):

    def __init__(self):
        super(YoudaoJa, self).__init__()

    def _get_from_api(self, lang='ja'):
    ...
    def _get_singledict(self, single_dict, lang='ja'):
